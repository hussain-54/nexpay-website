...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Send money anywhere. Settle instantly. No banks. No borders. No delays. NexPay is a blockchain-native stablecoin payment network across 150+ countries." },
      { name: "author", content: "NexPay" },
      { property: "og:title", content: "NexPay — The Global Stablecoin Payment Network" },
      { property: "og:description", content: "Send money anywhere. Settle instantly. No banks. No borders. No delays. NexPay is a blockchain-native stablecoin payment network across 150+ countries." },
